...
public class SpiderTaskController extends BaseAction {
    ...
    public ModelAndView index() {
        ...
        String spiderList = HttpUtil.sendGet(ResUrl.REMOTE_IP+ResUrl.SPIDER_LIST_URL, "","UTF-8");
    ...
    public ModelAndView editTshops(String spiderName,String runid) {
        try {
            ...
            String result = HttpUtil.sendGet(ResUrl.REMOTE_IP+ResUrl.SPIDER_START_URL,"name="+spiderName+"&runid="+runid,"UTF-8");
            if(null==result){
                return error("开启失败！");
            }
