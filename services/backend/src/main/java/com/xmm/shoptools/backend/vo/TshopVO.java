...
public class TshopVO extends BaseVo {
	private String id;
	//columns START
	private Long shopid;
    ...
    public String toString() {
        return "TshopVO [id=" + id + ", shopid=" + shopid + ", sellerId=" + sellerId
               + ", securityId=" + securityId + ", nick=" + nick + ", cid=" + cid + ", storeUrl="
               + storeUrl + ", category=" + category + ", type=" + type + ", location=" + location
               + ", serviceNumber=" + serviceNumber + ", storeDate=" + storeDate + ", status="
               + status + ", lastTimes=" + lastTimes + ", created=" + created + ", updated="
               + updated + "]";
    }
