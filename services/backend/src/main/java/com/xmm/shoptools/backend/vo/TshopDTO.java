...
public class TshopDTO {
    ...
    public String toString() {
        return "TshopDTO [id=" + id + ", securityId=" + securityId + ", nick=" + nick + ", cid="
               + cid + ", storeUrl=" + storeUrl + ", category=" + category + ", type=" + type
               + ", location=" + location + ", serviceNumber=" + serviceNumber + ", storeDate="
               + storeDate + ", status=" + status + ", lastTimes=" + lastTimes + ", created="
