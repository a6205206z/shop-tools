...
import com.xingmima.dpfx.rest.dto.BaseDTO;
...
public class BeanDTOUtil {
	private static final Logger log = LoggerFactory.getLogger(BeanDTOUtil.class);
	...
	public static <S extends BaseEntity, T extends BaseDTO> List<T> copyList(
